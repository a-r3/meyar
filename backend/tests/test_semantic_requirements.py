...
from meyar.schemas.criteria import CriterionKind, CriterionType, find_prohibited_term
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Temenos T24 təcrübəsi üstünlükdür.", "Temenos T24", "SKILL"),
        ("SAP S/4HANA təcrübəsi tələb olunur.", "SAP S/4HANA", "SKILL"),
        ("Oracle FLEXCUBE təcrübəsi tələb olunur.", "Oracle FLEXCUBE", "SKILL"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Bank təcrübəsini məcburi etmə, üstünlük kimi saxla.",
            lambda draft: any(item.value == "Banking" for item in draft.preferred),
        ),
        (
